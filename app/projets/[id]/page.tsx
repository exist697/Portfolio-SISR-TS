    ...
    <div className="container py-12">
      ...
      <Tabs defaultValue="presentation" className="w-full">
        ...
        <TabsContent value="presentation" className="mt-6 space-y-6">
          ...
          <Card>
            <CardHeader>
              <CardTitle>Outils et technologies utilisés</CardTitle>
            </CardHeader>
            <CardContent>
              <ul className="space-y-2">
        ...
        <TabsContent value="realisation" className="mt-6 space-y-6">
          <Card>
            <CardHeader>
              <CardTitle>Livrables</CardTitle>
              <CardDescription>Documents et éléments produits dans le cadre du projet</CardDescription>
            </CardHeader>
            <CardContent>
              <ul className="space-y-2">
                {projet.livrables.map((livrable, index) => (
                  <li key={index} className="flex items-start gap-2">
          ...
          <Card>
            <CardHeader>
              <CardTitle>Schéma d'architecture</CardTitle>
              <CardDescription>Représentation visuelle de la solution mise en place</CardDescription>
            </CardHeader>
            <CardContent className="flex justify-center">
              <div className="border rounded-lg p-4 w-full max-w-2xl">
                <div className="aspect-video bg-muted flex items-center justify-center">
                  <p className="text-muted-foreground">Schéma d'architecture du projet</p>
                </div>
              </div>
            </CardContent>
          </Card>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Illustrations des réalisations techniques</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="border rounded-lg p-2">
                  <div className="aspect-video bg-muted flex items-center justify-center">
                    <p className="text-muted-foreground">Capture d'écran 1</p>
                  </div>
                  <p className="text-sm text-muted-foreground mt-2 text-center">Configuration du système</p>
                </div>
                <div className="border rounded-lg p-2">
                  <div className="aspect-video bg-muted flex items-center justify-center">
                    <p className="text-muted-foreground">Capture d'écran 2</p>
                  </div>
                  <p className="text-sm text-muted-foreground mt-2 text-center">Interface d'administration</p>
                </div>
              </div>
            </CardContent>
          </Card>
